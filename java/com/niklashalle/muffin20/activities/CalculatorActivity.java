...
import com.niklashalle.muffin20.helper.Errors;
...
public class CalculatorActivity extends BaseActivity {
    ...
    **/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double precision = 2d;
        try {
            precision = Double.valueOf(mSharedPrefs.getString(mContext.getResources().getString(R.string.pref_key_calc), "2"));
        } catch (NumberFormatException nfe) {}
        mRoundingValue = Math.pow(10.0, precision);
    ...
    private boolean lastCharIsNumeric(String string) {
        ...
        else return Character.isDigit(string.charAt(string.length() - 1));
    }
